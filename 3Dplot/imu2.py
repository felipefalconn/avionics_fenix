...
def getEulerAngles(yaw, pitch, roll):
    ...
    try:
        ...
        # Check if the line has the correct number of numeric values
        ...
        print(f"Error reading values from serial port: {e}")
...
def main():
    ...
    while 1:
        ...
        values = parse_serial_data(serial_input_data)
